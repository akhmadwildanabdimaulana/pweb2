...
<body>
  <div class="atas">
    <center>
      <img src="images/log.png" class="img-fluid" style="width: 8%; transform: none;">
    </center>
    <h3>MyTicket</h3>
  </div>
    <div class="container">
    ...
    <img src="images/tiket.png" class="img-fluid" alt="Responsive image">
    </a>
    <p><h4>Lihat Tiket</h4>
    </div>
    <div class="col-sm col-md-2 col-lg-3 mt-3 text-center">
    ...
    <p><h4>Jadwal Konser <br>Selanjutnya</h4>
    </div>
  </div>
</div>
<div class="spasi"></div>
...
<div class="footer">
  <p>©Copyright | Akhmad Wildan Abdi Maulana</p>
</div>
</body>
</html>
