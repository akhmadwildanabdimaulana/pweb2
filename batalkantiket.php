...
<html>
<head>
    <title>MyTicket | Batalkan Tiket</title>
<?php
    require 'koneksi.php';
          ...
          echo'<table class="table">
              ...
              <tbody>';
                    ...
                    while ($row = $result1->fetch_assoc()) {
                        ...
                        <td>' . $row["wktTiba"] . '</td>
                        <td>' . $row["noKursi"] . '</td>
										<td><a href="batal-tiket.php?bis=' . $row["konserID"] . '&seat=' . $row["noKursi"] . '" class="btn btn-danger  role="button" onclick="myFunction()" value="Show alert box">Batal</a></td>
						      </tr>';
                    }
                    }
                    ?>
